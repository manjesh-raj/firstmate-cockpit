...
//
// `fm/cockpit-block-view-terminal`: env-var-gated self-test, same convention
...
// not simulated) before this file was written; see the PR description for
// those transcripts. This file verifies the *parsing* side in-process.
//

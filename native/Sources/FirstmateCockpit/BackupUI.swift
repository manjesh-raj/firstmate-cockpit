...
enum BackupUI {
    ...
    static func importFlow(from viewController: NSViewController, hostStore: HostStore, keyStore: SSHKeyStore, snippetStore: SnippetStore, onApplied: (() -> Void)? = nil) {
        ...
        switch source {
        case .local:
            importFromLocal(from: viewController, hostStore: hostStore, keyStore: keyStore, snippetStore: snippetStore, onApplied: onApplied)
        case .github:
            importFromGitHub(from: viewController, hostStore: hostStore, keyStore: keyStore, snippetStore: snippetStore, onApplied: onApplied)
        }
    }

    private static func importFromLocal(from viewController: NSViewController, hostStore: HostStore, keyStore: SSHKeyStore, snippetStore: SnippetStore, onApplied: (() -> Void)?) {
        ...
        diffAndApply(bundle, from: viewController, hostStore: hostStore, keyStore: keyStore, snippetStore: snippetStore, onApplied: onApplied)
    }
    ...
    private static func importFromGitHub(from viewController: NSViewController, hostStore: HostStore, keyStore: SSHKeyStore, snippetStore: SnippetStore, onApplied: (() -> Void)?) {
    ...
    /// confirm, apply, toast.
    private static func diffAndApply(_ bundle: GrandLineBackup, from viewController: NSViewController, hostStore: HostStore, keyStore: SSHKeyStore, snippetStore: SnippetStore, onApplied: (() -> Void)?) {

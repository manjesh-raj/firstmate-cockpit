...
//
// `fm/cockpit-block-view-terminal`: turns the OSC 133 stream `ShellIntegration`
...
// through it - see the PR description for the transcript.
//
...
/// Attached once per supported tab's `Terminal` (shell/ssh only - see
